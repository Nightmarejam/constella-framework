...
Constella is **not** software. It can be supported by software later, but the core deliverable is a **protocol + living doctrine**.
...
Constella is built as a “living civic operating framework” aimed at those three failure modes.
...
2. **Evidence levels**  
   Claims are graded by strength so speculation doesn’t pretend to be truth.

3. **Repair over punishment**  
   Conflict is processed into accountability + repair + reintegration (not endless exile).

4. **A baseline civic floor**  
   A community needs a stability layer so people don’t “bottom out” into chaos.

5. **Merit ≠ dominance**  
   Contribution can be recognized without creating an untouchable ruling class.
...
This layer is **optional** for newcomers. Constella stands on its own.
...
4) Choose a role + pick one “starter thread” to observe or contribute to (20 min).
...
5) **Decision**
6) **Audit / review**
7) **Iteration** (patch the doctrine and the process)
...
- **Civic floor:** baseline stability supports to prevent systemic collapse.
- **Merit token vs civic voice token:** recognition of contribution vs participation rights (names and mechanics can evolve, but the distinction matters).
