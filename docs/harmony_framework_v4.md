# Harmony Framework v4.0.0

*Full framework documentation for the Constella civic governance system.*
...
- **Celestial Equilibrium:** Systems succeed by harmonizing trust, dignity, and renewal
- **Resonance Governance:** Decisions judged by how they treat the "weakest resonance"
- **Phase Flip Zones:** Critical transition points in governance cycles

*Note: Full v4.0.0 framework uploaded to Claude session 2025-12-18*
*For complete documentation, see the original harmony_framework_complete_v4_0_0.md*
