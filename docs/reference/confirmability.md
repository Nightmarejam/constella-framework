# Confirmability schema
Status: v1 — committed 2026-07-02. This was designed in conversation (April–June 2026)
and has been operating uncommitted ever since: the conversation pipeline, homelab
extraction docs, and FAITHH doc-correction workflow all already use it. This file makes
it canonical. Constella is the basis of the AI logic stack; this schema is its
epistemic floor.
